...
c0.draw_contour(["PMSL", "TOT_PREC_S", 'var145_S'],1440, savebase = '/usr/users/stephan.rasp/tmp/c0contour', idtext = '081014a')
c0.draw_contour(["PMSL", "TOT_PREC_S", 'var145_S'],2880, savebase = '/usr/users/stephan.rasp/tmp/c0contour', idtext = '081014b')
c0.draw_contour(["PMSL", "TOT_PREC_S", 'var145_S'],4320, savebase = '/usr/users/stephan.rasp/tmp/c0contour', idtext = '081014c')
